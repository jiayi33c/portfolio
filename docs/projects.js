...
const projects = [
  ...
  },
  {
    ...
    description: "A conditional diffusion model reconstructs turbulent flow fields from masked observations, with customized elliptical masks aligned with the global velocity direction to incorporate directional flow structure.",
